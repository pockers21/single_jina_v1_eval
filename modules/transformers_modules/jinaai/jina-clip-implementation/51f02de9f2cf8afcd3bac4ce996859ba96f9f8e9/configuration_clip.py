...
if __name__=='__main__':
    if False: ##
        modelpath = '/Users/yr/Desktop/notebook1/download_model/jinaclip2'
        c=JinaCLIPConfig()
        c.from_pretrained(pretrained_model_name_or_path=modelpath) ##错的 和正确的有出入
        print(c)
    if 1:
        f = '/Users/yr/Desktop/notebook1/code/jinaclip_arch/modelClss1_加载模型/tmp1/clipcfg.pkl'

        d=pd.read_pickle(f)
        c = JinaCLIPConfig();c.from_dict(d)
        print(c)
