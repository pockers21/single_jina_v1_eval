...
class JinaCLIPPreTrainedModel(PreTrainedModel):
    ...
    def from_pretrained(cls, *args, **kwargs):
        ...
        return super().from_pretrained(*args, **kwargs) #### load weight
...
class JinaCLIPModel(JinaCLIPPreTrainedModel):
    ...
    def __init__(self, config: JinaCLIPConfig):
        ...
        config = _resolve_attention_libs(config);print(config)
        #wr=open('/Users/yr/Desktop/notebook1/code/jinaclip_arch/modelClss1_加载模型/tmp1/clipcfg.pkl','w')
        #f='/Users/yr/Desktop/notebook1/code/jinaclip_arch/modelClss1_加载模型/tmp1/clipcfg.pkl'
        #c=config.to_dict();#json.dump(c,wr,indent=2)
        #pd.to_pickle(c,f)
       # c1=pd.read_pickle(f)
